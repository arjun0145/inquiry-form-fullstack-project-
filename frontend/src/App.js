...
function App() {
  ...
  return (
    <div>
      ...
      <h3 id="cotation">" Logic and Logical Person Will change the world "</h3>
      <h3 id="author">...Arjun Kumar Chaturvedi</h3>
      <marquee direction="right"
        scrollamount="10" className="mark">
        NEW BATCH OF JAVA GOING TO START FROM 01-01-2023
      </marquee>
